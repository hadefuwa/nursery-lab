  ...
  const lessons = [
    {
      ...
      label: 'Shape Hunt',
      emoji: '🔷',
      route: '/lesson/shape-hunt',
      color: 'from-cyan-500 to-blue-600',
      shadow: 'shadow-blue-500/40',
      totalLevels: 8,
      description: 'Find the target shape and color'
    },
    {
      id: 'color-hunt',
      label: 'Color Hunt',
      emoji: '🎨',
      route: '/lesson/color-hunt',
  ...
  return (
    <div className="flex flex-col items-center justify-center py-12 px-4">
      <div className="text-center mb-10 max-w-3xl relative">
        ...
        <h2 className="text-5xl md:text-7xl font-black text-white mb-4 tracking-tighter drop-shadow-[0_0_25px_rgba(6,182,212,0.5)]">
          SHAPES AND COLORS
        </h2>
        <p className="text-xl text-cyan-200/70 font-bold tracking-widest uppercase mb-6">
          New category
        </p>
        <Link
          to="/"
